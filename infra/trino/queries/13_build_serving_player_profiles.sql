-- Rebuilds player-level serving table for dashboards and application reads.
DROP TABLE IF EXISTS tf2.default.serving_player_profiles;

CREATE TABLE tf2.default.serving_player_profiles
WITH (
  format = 'PARQUET'
) AS
WITH latest_form AS (
