-- Rebuilds map/day serving table for trend dashboards.
DROP TABLE IF EXISTS tf2.default.serving_map_overview_daily;

CREATE TABLE tf2.default.serving_map_overview_daily
WITH (
  format = 'PARQUET',
...
ORDER BY mg.match_date DESC, mg.games DESC, mg.map;
